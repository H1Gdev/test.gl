...
static const char *HELP_MESSAGE = "\n"
        "Usage: compressed_image <source image data file> <output image data file>\n"
        "\n"
...
static void print_formats(const std::vector<cl_image_format> &formats);
static std::vector<cl_image_format> get_image_formats(cl_context context, cl_mem_flags mem_flags);
static bool is_format_supported(const std::vector<cl_image_format> &formats, const cl_image_format &format);
