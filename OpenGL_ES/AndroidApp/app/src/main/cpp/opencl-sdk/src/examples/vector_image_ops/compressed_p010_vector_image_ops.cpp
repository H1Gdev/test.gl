...
#endif
{
    ...
    std::array<kernel_exec_params_t, 4> kernel_execution_params{
            ...
            kernel_exec_params_t{copy_kernels[1], src_p010_image, compressed_uv_plane, work_units(src_p010_desc.image_width, 4), work_units(src_p010_desc.image_width, 4), comp_t::UV_ONLY},
            kernel_exec_params_t{copy_kernels[2], src_uv_plane,   compressed_uv_plane, work_units(src_p010_desc.image_width, 4), work_units(src_p010_desc.image_width, 4), comp_t::UV_ONLY},
            kernel_exec_params_t{copy_kernels[3], src_y_plane,    compressed_y_plane,  src_p010_desc.image_width / 2,            src_p010_desc.image_width / 2,            comp_t::Y_ONLY},
    };
