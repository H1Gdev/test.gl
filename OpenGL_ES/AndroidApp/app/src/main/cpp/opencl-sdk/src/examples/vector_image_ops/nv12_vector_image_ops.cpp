...
#endif
{
    ...
    std::array<kernel_exec_params_t, 6> kernel_execution_params{
            ...
            kernel_exec_params_t{copy_kernels[1], src_nv12_image, out_uv_plane, work_units(src_nv12_desc.image_width, 4), work_units(src_nv12_desc.image_width, 4), comp_t::UV_ONLY},
            ...
            kernel_exec_params_t{copy_kernels[4], src_uv_plane,   out_uv_plane, work_units(src_nv12_desc.image_width, 4), work_units(src_nv12_desc.image_width, 4), comp_t::UV_ONLY},
            kernel_exec_params_t{copy_kernels[5], src_y_plane,    out_y_plane,  work_units(src_nv12_desc.image_width, 4), src_nv12_desc.image_width,                comp_t::Y_ONLY},
    };
